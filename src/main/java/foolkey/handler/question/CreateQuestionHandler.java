...
import foolkey.pojo.root.bo.order.OrderAskQuestionBO;
...
public class CreateQuestionHandler extends AbstractBO {
    ...
    @Autowired
    private OrderAskQuestionBO orderAskQuestionBO;
    ...
    public void execute(
        ...
        //  1. 存储问题DTO
        questionBO.createQuestion(questionAnswerDTO);
        //  2.存储订单DTO
        OrderAskQuestionDTO orderAskQuestionDTO = orderAskQuestionBO.createOrderAsk(studentDTO, questionAnswerDTO);
        //返回result
