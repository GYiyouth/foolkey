 ...
 */
@Controller
@RequestMapping(value = "/evaluationStudent/getEvaluationStudent")
...
//            @RequestParam("teacherId")Long teacherId,
        ...
        try {
            ...
            //获取这个学生的评论
            ArrayList<EvaluationStudentDTO> evaluationStudentDTOS = evaluationInfoBO.getEvaluationStudentDTOByStudentId(studentId,pageNo, StaticVariable.PAGE_SIZE);
