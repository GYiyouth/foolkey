...
//        Long teacherId = studentDTO.getId();
        ...
        try {
            ...
            for(Long courseId:courseIdS){
                ...
                //      2.2由课程id获取申请-学生DTOS
                List<OrderBuyCourseWithStudentAsTeacherSTCDTO> orderBuyCourseWithStudentAsTeacherSTCDTOS = orderInfoBO.getOrderBuyCourseWithStudentAsTeacher(courseId,1,4, OrderStateEnum.agreed, OrderStateEnum.onClass);
...
//            List<OrderBuyCourseDTO> orderBuyCourseDTOS_Reward = orderInfoBO.getOrderBuyCourseDTOAsTeacherByOrderStates(teacherId, CourseTypeEnum.学生悬赏, pageNo, StaticVariable.pageSize, OrderStateEnum.agreed, OrderStateEnum.onClass);
//            //封装悬赏订单
...
//            //******** 课程 *****************
//            //按照订单状态，该老师下面的课程订单
//            List<OrderBuyCourseDTO> orderBuyCourseDTOS_Course = orderInfoBO.getOrderBuyCourseDTOAsTeacherByOrderStates(teacherId, CourseTypeEnum.老师课程, pageNo, StaticVariable.pageSize, OrderStateEnum.agreed, OrderStateEnum.onClass);
//            //封装课程订单
//            ArrayList<OrderBuyCourseAsTeacherSTCDTO> orderBuyCourseSTCAsTeacherDTOS = orderInfoBO.convertOrderBuyCourseDTOIntoOrderBuyCourseSTCDTO(orderBuyCourseDTOS_Course);
